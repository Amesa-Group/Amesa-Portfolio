  ...
  return (
    <div className='md:px-[11%] px-6 mt-16 w-full h-[90vh] md:h-[80vh] bg-white dark:bg-[#09111f] flex md:flex-row flex-col-reverse items-center justify-center  md:justify-between'>
     ...
     data-aos-anchor-placement="top-center">
      <h2 id="text-3xl" className='md:text-5xl text-4xl  md:text-left text-center font-bold text-[#f5c32c]'>Do you need a website?</h2>
      <h3 id="text-3xl" className='md:text-6xl text-5xl font-bold text-[#242D49] md:text-left text-center dark:text-white'>Start Your Dream <br/> Website!</h3>

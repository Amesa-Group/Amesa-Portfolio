  ...
  return (
    ...
    <span id="text-sm" className=' text-xl text-[#222] dark:text-gray-300 mt-3'>© {year} Amesa Solutions . All rigths reserved</span>
      <ul className=' flex items-center justify-center gap-4 text-gray-400'>
        <Link to="https://www.facebook.com/AmesaSolutions" className='hover:text-[#f5c32c] '><FaFacebook/></Link>
        <Link to="https://wa.link/27nf32" className='hover:text-[#f5c32c] '><FaWhatsapp/></Link>
        <Link to="https://twitter.com/AmesaSolutions" className='hover:text-[#f5c32c] '><FaTwitter/></Link>
      </ul>
    </div>
  )
}
